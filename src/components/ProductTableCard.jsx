  ...
  return (
    <div className='bg-white rounded-lg shadow-slate-100 shadow-md flex flex-col p-2 mt-4'>
        <div className="flex p-3">
            ...
            <div className='ml-auto w-auto p-1 border-none rounded h-7 flex items-center bg-slate-50'>
                        <MdSearch  className='text-slate-400'/>
                        <input className='text-xs ml-1  bg-slate-50'  placeholder='Search'></input>
            </div>
            <select className='ml-3 text-slate-400 text-xs bg-slate-50 rounded-md h-7 p-1'>
